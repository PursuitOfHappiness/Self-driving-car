...
namespace automotive {
    namespace miniature {
        ...
        void LaneFollower::measuringMachine() {
            ...
            const double OVERTAKING_DISTANCE = 6; //use 6 for simulator, 40 for real
            ...
            if (stageMeasuring == FIND_OBJECT_INIT) {
                ...
                if ( (sbd.getValueForKey_MapOfDistances(INFRARED_FRONT_RIGHT) > 0) and  (sbd.getValueForKey_MapOfDistances(INFRARED_REAR_RIGHT) > 0)) {
                    // Turn to right.
        ...
        void LaneFollower::movingMachine(bool has_next_frame) {
            ...
            if (stageMoving == FORWARD && true == has_next_frame) {
                ...
                stageToRightLaneRightTurn--;
                if (stageToRightLaneRightTurn < 30) {
