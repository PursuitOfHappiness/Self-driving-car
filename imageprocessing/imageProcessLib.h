...
class imageProcess
{
    ...
    public:
        ...
        imageProcess();
        imageProcess(int width, int height);
        ...
        void makeBinary(cv::Mat &input, double thres);

        // Contrast the image
        void Contrast(cv::Mat &input, double alpha, double beta);

        // Custom threshold
        void Theshold(cv::Mat &input, uchar light);

        // Fix light
        void fixLight(cv::Mat &input, cv::Mat &output, uchar range);
        ...
        void ROIMaker(cv::Mat &input, cv::Mat &output, int verticalPos, int horizontalPos, int skewed);
        ...
        void skelMaker(cv::Mat &input, cv::Mat &output);
        ...
        void filterWhiteAreas(cv::Mat &input, cv::Mat &output, double whiteAreaMaxLimit, double whiteAreaMin, double whiteLengthLimit);
        ...
        void HoughlinesPLR(cv::Mat &input, cv::Mat output, double houghThreshold, double minLineLength, double maxLineGap);
};
