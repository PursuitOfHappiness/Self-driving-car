    ...
    namespace miniature {
        ...
        void Proxy::setUp() {
            ...
            try {
                ...
                //const string SERIAL_PORT = "/dev/pts/25";
        ...
        void Proxy::nextString(const string &string){
            stringstream stream;
            cout << "Proxy::nextString called with " << string << endl;

            if(processCarString(string) == 1){
                //cout << "Proxy:nextString processCarString success!" << endl;
            } else {
                //cout << "Proxy:nextString processCarString FAIL!" << endl;
            }
        }
