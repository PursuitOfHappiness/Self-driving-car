...
#ifndef ArduinoTESTSUITE_H_
#define ArduinoTESTSUITE_H_
 ...
 */
class ArduinoTestling : public Arduino {
    private:
        ArduinoTestling();
    
    public:
        ArduinoTestling(const int32_t &argc, char **argv) :
            Arduino(argc, argv) {}

        // Here, you need to add all methods which are protected in Arduino and which are needed for the test cases.
};

/**
 * The actual testsuite starts here.
 */
class ArduinoTest : public CxxTest::TestSuite {
    private:
        ArduinoTestling *dt;
    ...
    public:
        ...
        void setUp() {
            ...
            dt = new ArduinoTestling(argc, argv);
        }
        ...
        void testArduinoSuccessfullyCreated() {
            TS_ASSERT(dt != NULL);
        }
    ...
    private:
         ...
         */
        ArduinoTest(const ArduinoTest &/*obj*/);
         ...
         */
        ArduinoTest& operator=(const ArduinoTest &/*obj*/);

};

#endif /*ArduinoTESTSUITE_H_*/
